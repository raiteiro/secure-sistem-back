...
{
    /// <inheritdoc />
    public partial class AddQuotesAndPurchaseOrders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRateValue = table.Column<decimal>(type: "decimal(9,4)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_CompanyId_FolioNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotes_CompanyId_FolioNumber",
                table: "Quotes",
                columns: new[] { "CompanyId", "FolioNumber" },
                unique: true);
